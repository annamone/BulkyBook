...
namespace BulkyBookWeb.Areas.Customer.Controllers
{
	...
	public class CartController : Controller
	{
		...
		[BindProperty] // SummeryPost მეთოდს გადასცემს ShoppingCartVM shoppingCartVM ამ მოდელს ავტომატურად
		...
		public IActionResult OrderConfirmation(int id)
		{
			...
			_emailSender.SendEmailAsync(orderHeader.ApplicationUser.Email, "New Order - Bulky Book", "<p>New Order Created, Order Id - " + orderHeader.Id + "</p>");
